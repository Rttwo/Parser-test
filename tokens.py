TOKENS = [
    ...
    # Исправлен адрес TURBO (был неверный)
    {"mint": "0xA35923162C49cF95e6BF26623385eb431ad920D3",
     "symbol": "TURBO", "name": "Turbo", "chain": "ethereum"},

    # Исправлен адрес SPX (последний символ был F, правильно c)
    {"mint": "0xe0f63a424a4439cbe457d80e4f4b51ad25b2c56c",
    ...
    # MEXC тикер: XIONGMAOTOU_USDT
    {"mint": "0xf3525965a4aD3ca0AC13f4D2F237113691194444",
     "symbol": "XIONGMAOTOU", "name": "熊猫头 (Panda Head)", "chain": "bsc"},

    # ══ TON ══════════════════════════════════════════════════
    # MEXC тикер: UTYA_USDT
    {"mint": "EQBaCgUwOoc6gHCNln_oJzb0mVs79YG7wYoavh-o1ItaneLA",
     "symbol": "UTYA", "name": "Utya", "chain": "ton"},
